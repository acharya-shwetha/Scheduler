...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public int updateTask(long taskId,String taskName,Date selectedDate,String taskPlace,Double latitude,Double longitude,Double taskDuration)
    {
        ContentValues values = new ContentValues();
        values.put("taskName", taskName);
        values.put("taskDate", selectedDate.getTime());
        values.put("taskPlace", taskPlace);
        values.put("latitude", latitude);
        values.put("longitude", longitude);
        values.put("duration", taskDuration);
        int id = database.update("TASKS",values,"id ="+taskId,null);
        Log.i("DB","update tasks by id = "+taskId);
        return id;
    }
