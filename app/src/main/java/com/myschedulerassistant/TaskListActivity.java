...
public class TaskListActivity extends AppCompatActivity {
    ...
    private void updateTask() {
        ...
        //On click of child view of task will open
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            @Override
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                //Toast.makeText(TaskListActivity.this, "groupPosition: "+i, Toast.LENGTH_SHORT).show();
                Intent viewTask = new Intent(TaskListActivity.this,ViewTask.class);
                viewTask.putExtra("Task ID",taskIdList.get(i));
        ...
        public View getGroupView(final int groupPosition, boolean isExpanded,
            ...
            mdeleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dbHelper.open();
                    //Task selectedTask = dbHelper.getTaskById(taskIdList.get(groupPosition));
                    dbHelper.deleteTask(taskIdList.get(groupPosition));
                    updateTask();
                    listAdapter.notifyDataSetChanged();
                }
            });
