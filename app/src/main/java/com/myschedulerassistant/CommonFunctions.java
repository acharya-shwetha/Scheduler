...
/**
 * Created by Shwetha on 11/19/2017.
 */
...
public class CommonFunctions {
    ...
    public static Double[] getDistanceAndDuration(final double lat1, final double lon1, final double lat2, final double lon2, GoogleMap mMap) {
        ...
        try {
            ...
            parsedDistance = parsedDistance / 1609.34;
            Log.i(CommonFunctions.class.getName(), "parsed distance in miles " + parsedDistance);
            ...
            if (parsedDistance != null && mMap != null) {
                ...
                line.setPoints(list);
                line.setTag("Distance " + parsedDistance + " miles and time to travel is " + durationInMins.intValue() + " mins");
            }
        } catch (Exception e) {
            e.printStackTrace();
            return null;
